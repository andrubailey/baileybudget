          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-border bg-bg">
                ...
                <th className="px-6 py-2 text-xs font-medium text-text-muted">Need?</th>
                ...
                <th className="px-6 py-2 text-xs font-medium text-text-muted">Remaining</th>
              </tr>
            </thead>
            <tbody>
              {expenseProgress.map((c) => (
                <tr key={c.id} className="border-b border-border last:border-b-0">
                  <td className="px-6 py-3 text-sm font-medium text-text">{c.name}</td>
                  ...
                  <td className="px-6 py-3">
                    ...
                    >
                      <input
                        ...
                        className="w-28 rounded-md border border-border bg-bg px-2 py-1 text-sm text-text outline-none focus:border-accent"
                      />
                      <button
                        type="submit"
